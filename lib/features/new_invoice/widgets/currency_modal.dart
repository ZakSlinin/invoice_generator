...
class CurrencyModal extends StatelessWidget {
  ...
  const CurrencyModal({super.key, required this.textTheme});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(child: Text('Currency', style: textTheme.bodyLarge)),
              const SizedBox(height: 24),
              _buildMostRecentSection(context),
              const SizedBox(height: 24),
              _buildAllCurrenciesSection(context),
              // Add more spacing at the bottom if needed to prevent keyboard overlap
              SizedBox(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          // Spacer to push Currency title to center
          const Spacer(),
          const SizedBox(width: 48), // Adjust as needed to align header
        ],
      ),
    );
  }
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(currency['code']!, style: textTheme.bodyMedium),
                    Text(
                      currency['name']!,
                      style: textTheme.bodyMedium?.copyWith(color: Colors.grey),
                    ),
