...
import 'package:invoice_generator/features/shared/data/repositories/invoice_repository_impl.dart';
...
void setupDependencies() {
  ...
  getIt.registerSingleton<AbstractInvoiceRepository>(InvoiceRepositoryImpl());
  getIt.registerSingleton<InvoiceBloc>(
    InvoiceBloc(getIt<AbstractInvoiceRepository>()),
  );
}
